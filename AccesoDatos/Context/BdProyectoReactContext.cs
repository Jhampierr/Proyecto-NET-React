...
public partial class BdProyectoReactContext : DbContext
{
    public BdProyectoReactContext()
    {
    }

    public BdProyectoReactContext(DbContextOptions<BdProyectoReactContext> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=(localdb)\\MSSQLLocalDB;Database=BD_Proyecto_React;User Id=admin;Password=123456;TrustServerCertificate=True;");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Alumno>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__alumno__3213E83F850C90A5");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__asignatu__3213E83F17170E17");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__califica__3213E83FF09A407E");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__matricul__3213E83F216ECB68");
        ...
        {
            entity.HasKey(e => e.Usuario).HasName("PK__profesor__9AFF8FC7A019F293");
